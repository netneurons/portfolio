  ...
  $template = htmlspecialchars($_POST['template']);
   ...
   mkdir($folder_name);
    ...
    $image_name = 'profile.png';
      ...
      //image location
      $imgloc = 'https://portfolio.glitch.me/' . $folder_name2 . '/profile.png';
      ...
      <nav class="bg-gray-800 py-4">
         <div class="px-4 lg:px-8 mx-auto sm:px-6">
            <div class="flex items-center h-16 justify-between">
               <div class="flex items-center"><a class="font-bold text-xl text-white"href="#">Port Labs</a></div>
...
if($template === '1'){
   file_put_contents($folder_name . '/index.html', $html1);
        echo 'https://portfolio.glitch.me/'. $spname;
}else{
   if($template === '2'){
