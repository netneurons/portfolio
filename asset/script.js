  ...
  function submit() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        var errormsg = 'We think that you already have a portfolio at https://portfolio.glitch.me/' + fname + '_' + lname + '. If not or you want to remove it please contact us by sending email at elyagoubiabdessattar@gmail.com';
  ...
  function show() {
    var fname = document.querySelector('input[name="fname"]').value;
    var lname = document.querySelector('input[name="lname"]').value;
    pic = 'https://portfolio.glitch.me/' + fname + '_' + lname + '/profile.png';
    Swal.fire({
      icon: 'question',
      title: 'is that you?',
